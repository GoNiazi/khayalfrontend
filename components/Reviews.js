                  ...
                  <div className="d-sm-flex">
                    <div className="flex-shrink-0 mb-3 mb-sm-0">
                      <img
                        ...
                        src={
                          review[0].attributes.image.image.data.attributes.url
                        }
                  ...
                  <div className="d-sm-flex">
                    <div className="flex-shrink-0 mb-3 mb-sm-0">
                      <img
                        className="avatar avatar-lg avatar-circle"
                        src={
                          review[1].attributes.image.image.data.attributes.url
                        }
                        alt="Image Description"
                      />
                    </div>
                  ...
                  <div className="d-sm-flex">
                    <div className="flex-shrink-0 mb-3 mb-sm-0">
                      <img
                        className="avatar avatar-lg avatar-circle"
                        src={
                          review[2].attributes.image.image.data.attributes.url
                        }
                        alt="Image Description"
                      />
                    </div>
                  ...
                  <div className="d-sm-flex">
                    <div className="flex-shrink-0 mb-3 mb-sm-0">
                      <img
                        className="avatar avatar-lg avatar-circle"
                        src={
                          review[3].attributes.image.image.data.attributes.url
                        }
                        alt="Image Description"
                      />
                    </div>
