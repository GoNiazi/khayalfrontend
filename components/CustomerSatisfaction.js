...
import styles from "../styles/CustomerSat.module.css";
              ...
              <div className="row align-items-lg-center">
                <div className="col-lg-7 order-lg-2 mb-10 mb-lg-0">
                  <div className="position-relative">
                    <div className="w-75 ms-auto"></div>

                    <div className="position-absolute bottom-0 start-0 mb-10 ms-5"></div>
                  ...
                  <div className="row align-items-lg-center">
                    <div className="col-lg-7 order-lg-2 mb-10 mb-lg-0">
                      <div className="position-relative">
                        <div className="w-75 ms-auto">
                          <img
                            className={`img-fluid rounded-3 ${styles.backpic}`}
                            src={
                        ...
                        >
                          <img
                            className={`img-fluid ${styles.frontpic}`}
                            src={
                    ...
                    <div className="col-lg-5">
                      <div className="pe-lg-5">
                        ...
                        <Link href="/feedback">
                          <a className="btn btn-primary btn-pointer">
                            Feedback
                          </a>
                        </Link>
                      </div>
